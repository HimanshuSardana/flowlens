...
import { login, handleGitHubLogin } from './actions';
						...
						<form onSubmit={handleSubmit}>
							<div className="mt-5 flex flex-col gap-3">
								...
								<div className="flex gap-3 justify-center w-1/2">
									<Button onClick={() => handleGithubSubmit} fullWidth className='dark:bg-zinc-900' radius='sm'>GitHub</Button>
									<Button fullWidth className='dark:bg-zinc-900 ' radius='sm'>Google</Button>
								</div>
