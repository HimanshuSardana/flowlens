			...
			<div className="flex h-[70vh] items-center">
				...
				<div className="left flex flex-col gap-5">
					<div className="left flex flex-col gap-2">
						...
						<p className='text-default-400 w-1/2'>Lorem ipsum dolor sit amet <span className='underline text-blue-500 decoration-wavy'> adipisicing </span>elit. Expedita sunt autem libero laudantium perspiciatis error!</p>
